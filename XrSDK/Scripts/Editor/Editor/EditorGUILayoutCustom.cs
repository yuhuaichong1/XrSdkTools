...
namespace XrSDK
{
    public static class EditorGUILayoutCustom
    {
        ...
        public static Vector2 BeginScrollView(Vector2 scrollPosition)
        {
            ...
            GUI.skin = EditorCustomStyles.Instance.Skin;

            Vector2 tempScrollPosition = EditorGUILayout.BeginScrollView(scrollPosition, EditorCustomStyles.Instance.Skin.horizontalScrollbar, EditorCustomStyles.Instance.Skin.verticalScrollbar);
        ...
        public static void DrawCompileWindow(Rect editorRect)
        {
            if (EditorApplication.isCompiling)
            {
                ...
                GUI.Box(rect, "Compiling..", EditorCustomStyles.Instance.boxCompiling);
            }
        }
        ...
        {
            EditorGUILayout.BeginHorizontal(EditorCustomStyles.Instance.padding05, GUILayout.Height(21), GUILayout.ExpandWidth(true));

            EditorGUILayout.LabelField(title, EditorCustomStyles.Instance.boxHeader, GUILayout.ExpandHeight(true), GUILayout.ExpandWidth(true));

            GUILayout.FlexibleSpace();

            EditorGUILayout.BeginVertical(GUILayout.ExpandHeight(true));
            GUILayout.FlexibleSpace();
            value = EditorGUILayout.Toggle(value, EditorCustomStyles.Instance.Skin.toggle, GUILayout.Width(32), GUILayout.Height(21));
            GUILayout.FlexibleSpace();
        ...
        {
            Rect rect = EditorGUILayout.BeginHorizontal(EditorCustomStyles.Instance.padding05, GUILayout.Height(21), GUILayout.ExpandWidth(true));
        ...
        {
            EditorGUILayout.BeginHorizontal(EditorCustomStyles.Instance.Skin.box);
            ...
            EditorGUILayout.LabelField(title, EditorCustomStyles.Instance.helpboxLabel, GUILayout.ExpandHeight(true));
